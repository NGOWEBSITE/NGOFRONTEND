...
const contactDetails = [
  { label: 'Email', value: 'hello@nurtureglobal.org', icon: FiMail },
  { label: 'Phone', value: '+255 712 345 678', icon: FiPhone },
        ...
        <section className="surface-card p-8">
          <form className="grid gap-5">
            ...
            <div>
              ...
              <input id="email" name="email" type="email" className="mt-2 w-full rounded-lg border border-slate-300 px-4 py-3 transition focus:border-emerald-600 focus:ring-2 focus:ring-emerald-100" placeholder="jane@example.com" />
            </div>
            <div>
