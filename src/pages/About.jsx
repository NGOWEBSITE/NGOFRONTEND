    ...
    <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <div className="surface-card mt-10 p-8">
        ...
        <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
          {values.map((value) => (
            <div key={value} className="rounded-lg border border-slate-200 bg-slate-50 p-4 text-center font-semibold text-slate-700">
              {value}
            </div>
          ))}
        </div>
        ...
        <section className="surface-card p-8">
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-3">
            {leadership.map((member) => (
              <div key={member.name} className="rounded-lg border border-slate-200 bg-slate-50 p-5">
      ...
      <section className="soft-panel mt-10 p-8">
